...
subtitle: "Welcome! 1st SARA Summer School, 22-26 July 2024, Sonipat."
format: 
  revealjs:
    theme: [default, style.scss]
#controls: true
pagetitle: RR using R
logo: images/sara_logo.png
slide-number: true
#embed-resources: true
from: markdown+emoji
code-line-numbers: false
footer: "[https://rep-research-using-r.netlify.app/](https://rep-research-using-r.netlify.app/)"
execute: 
  echo: true
title-slide-attributes:
  data-background-image: "https://images.unsplash.com/photo-1510524813428-edec31e26317?q=80&w=2073&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
...
::: {.column width="75%"}
- Charitable education institute.

- To empower underrepresented communities in India through data science education.

- For more information, please visit our website: <https://sara-edu.netlify.app/>
...
{{< fa globe >}} [SARA Institute of Data Science](https://sara-edu.netlify.app/)

{{< fa brands twitter >}} [@sara_institute](https://twitter.com/sara_institute)

{{< fa brands github >}} [Slide source code](https://github.com/sara-edu/slides-rr-using-r)

```{=html}
<a class="github-button" href="https://github.com/sara-edu/slides-rr-using-r" data-icon="octicon-star" data-size="large" data-show-count="true" aria-label="Star this course on Github">Star This Course on Github</a><script async defer src="https://buttons.github.io/buttons.js"></script>
```
...
# [🎈Reproducible Research]{.white} {.inverse}
...
![](images/manual-update.svg){width=75%}
...
# {.inverse background-image=images/exploder.gif background-size=25% background-position="top"}

<br>
<br>

[R Programming Language]{.white .r-fit-text}
...
::: aside
Source: <https://www.reddit.com/r/datascience/comments/154qdbv/why_do_people_use_r/>
:::
...
# {.inverse background-image=images/code_hero.gif background-size="20%" background-position="top"}

<br>
<br>
<br>

[Coding in R]{.r-fit-text}
...
## [R & RStudio]{style="background-color:silver"}
...
[{{< fa gear size=7x >}}]{style="color:gold"}
:::
